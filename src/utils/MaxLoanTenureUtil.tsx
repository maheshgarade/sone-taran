...
export const calculateMaxLoanTenure = (loanAmount: number, itemValue: number, annualRate: number): number => {
    let months = 0;
...
export const calculateMaxLoanTenure2 = (loanAmount: number, itemValue: number, annualRate: number): number  => {
